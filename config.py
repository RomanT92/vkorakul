...
ПРАВИЛА ДЛЯ ПОЛЯ "item" (КРИТИЧЕСКИ ВАЖНО):
1. ВЫДЕЛЯЙ СУТЬ: Очищай название от лишних прилагательных, свойств, брендов и глаголов (например, 'новый', 'старый', 'красный', 'купил', 'вкусный'). 
2. Оставляй только ГЛАВНОЕ СУЩЕСТВИТЕЛЬНОЕ (или базовую смысловую пару слов). 
   Пример 1: "новый регистратор 5000" -> item: "регистратор", comment: "новый"
   Пример 2: "вкусный кофе 200" -> item: "кофе", comment: "вкусный"
   Пример 3: "купил большую шаурму 300" -> item: "шаурма", comment: "купил большую"
3. Уважай реальные имена (не исправляй "Кате" на "Кафе").
4. Исправляй ТОЛЬКО абсолютно очевидные опечатки.
5. НЕ пиши слова 'приход', 'расход' или 'доход' в название! Оставь поле пустым (""), если кроме суммы ничего нет.
6. НИКОГДА не добавляй поля "category" или "subcategory".
"""
