...
{
  "item": "Название покупки или источник дохода (1-3 слова, например: 'такси', 'продукты', 'зарплата', 'от васи'). НЕ пиши сюда слова 'приход', 'расход' или 'доход'!",
  "amount": 1500,
  "type": "Расход" (или "Доход", если суть сообщения — получение денег, например: "приход", "дали", "зарплата", "перевели"),
